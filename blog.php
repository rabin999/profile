            ...
            <div class="row align-center flex-end">
                <div class="search">
                    <form action="search.php" method="post" class="rb-form">
                        <input class="blog-input" type="search" placeholder="Search...">
                        <span>
                                <svg aria-hidden="true" data-prefix="fas" data-icon="search" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <div class="rb-date-range-picker">
                    <input class="blog-input" type="text" id="blog-from-to-range" placeholder="Blog date...">
                </div>
                <div class="rb-toggle-view">
                    <ul>
                        <li>
                            <button title="List View" id="list_view" class="active blog-button">
                                <svg aria-hidden="true" data-prefix="fas" data-icon="list-ul" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <li>
                            <button title="Grid View" id="grid_view" class="blog-button">
                                <svg aria-hidden="true" data-prefix="fas" data-icon="th" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
