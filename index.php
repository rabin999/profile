...
<main class="container">
    ...
    <!-- About Me -->
    <div class="aboutMe" rel="aboutMe" style="min-height: 1020px">
    ...
    <!-- Projects -->
    <div class="projects" rel="projects" style="min-height: 1020px;max-height: 1020px;">
    ...
    <!-- Contact -->
    <div class="contact" rel="contact" style="min-height: 1020px;max-height: 1020px;">
        ...
        <div class="row hire-detail">
            ...
            <div class="col">
                <form action="#" class="no-overflow">
                    ...
                    <div class="row">
                        <div class="group col">
                            <input type="text" name="project" title="Project Title" required>
                    ...
                    <textarea name="detail" cols="30" rows="10" title="Project Detail">Detail</textarea>
